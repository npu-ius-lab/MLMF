...
class LoadImages:
    ...
    def __next__(self):
        ...
        if self.video_flag[self.count]:
            ...
            # s: index of the image in datasets
        ...
        return path, img, img0, self.cap, self.count # default: the last return is 's', I changed to self.count
...
class LoadStreams:
    ...
    def __next__(self):
        ...
        # Convert
        # print(img,'11111111111111111111111111111111')
